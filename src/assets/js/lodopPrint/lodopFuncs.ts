 ...
 */
var CreatedOKLodop7766: HTMLObjectElement | null = null, CLodopIsLocal: boolean;
...
//====获取LODOP对象的主过程：====
export default function getLodop(oOBJECT?: { parentNode: { removeChild: (arg0: any) => void; }; } | undefined, oEMBED?: { parentNode: { removeChild: (arg0: any) => void; }; } | undefined) {
